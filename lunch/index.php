...
<main id="main">
  ...
  <section class="l-main -flx">
    <section class="l-main__left -positionEnd">
      <div class="-position">
        <h1 class="c-title -LL -eng">Lunch<span>ランチ</span></h1>
        <div class="l-main__left---lead">心地よい賑わいと 四季を映しだす庭園が 魅力のランチタイムシェフ特製のランチコースで 優雅なひとときを</div>
        <div class="-smallMenu">
          <h2 class="-eng -colorBwn">Lunch Menu</h2>
          <dl>
            <div>
              <dt class="-eng">Chef’s Lunch<span class="-jpn">シェフズランチ</span></dt>
              <dd class="-eng">¥3,500</dd>
            </div>
            <div>
              <dt class="-eng">Steak Lunch<span class="-jpn">ステーキランチ</span></dt>
              <dd class="-eng">¥4,800</dd>
            </div>
            <div>
  ...
  <section class="l-main -flx -timeschedule">
    <section class="-layout">

      <div class="-schedule">
        <h2 class="-eng -colorBwn">Lunch Time Schedule</h2>
...
<a href="<?php echo $path; ?>dinner/" class="-float">
  <div>Dinner<span>ディナー</span></div>
</a>
